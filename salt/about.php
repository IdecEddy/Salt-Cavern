<html>
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Raleway:400,700,700italic' rel='stylesheet' type='text/css'>
    ...
    <body>
        <div id='header'>
            ...
            <figure id="header-figure">
                <image  id="header-img" src='images/waves.jpeg'>
            </figure>
            <div id="header-text">
                <p>THE SALT CAVERN </p>
            </div>
        ...
        Speleotherapy and Halotherapy have been effective in reducing symptoms in many areas of health. Although treatments are most used to remedy lung-related disorders, salt has also been used to care for skin conditions, anxiety, stress, ENT illnesses, and has been utilized to improve the immune system. Conditions that are treated with salt include, but are not limited to:
                    <br />
                    <br />

                    <ul>
                        <li> Asthma </li>
                        <li> Allergic colds, Hay Fever and Rhinopathy </li>
                        <li> Chronic bronchitis </li>
                        <li> Sinusitis </li>
                        <li> Frequent viral infections </li>
        ...
        As a health care practitioner, the use of salt is very beneficial to my clients, as well as myself. It's important that my clients enter a pure environment, and leave feeling better than when they arrived. Being that salt is a natural mood elevator, stress reducer, and offers respiratory relief, salt lamps and air ionizers is a wise choice and a good investment for both my home and office.
                ...
                <div class="source">
                    © 2010 Long Island Sports Massage -- All Rights Reserved.
                    <br /><br />
                    Jaime Savarese is a Licensed Massage Therapist and owner of Long Island Sports Massage. She is widely considered the foremost expert in Massage Therapy in Suffolk County, New York. If you'd like more tips such as these be sure to visit http://www.LongIslandSportsMassage.com, and connect with Jaime online at http://www.facebook.com/JaimeSavareseLMT.
                    <br /></br />
                    Article Source: http://EzineArticles.com/3885753
            ...
            <div id='side-container'>
                <div id='slider'>
                    ...
                    <div id="time-open">
                        ...
                        <br />
                        <p>
                        <strong class="days-open">
                            M - F 
                        </strong>
                        <strong class="time-open">   
                            11a - 7p 
                        </strong>
                        <br />
